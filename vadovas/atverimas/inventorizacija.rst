...
Duomenų rinkinių sąrašo sudarymas (aprašyta žemiau),
...
informacines sistema, registrus, jau teikiamus ar atvertus duomenis ir sudaro įstaigos
valdomų informacinių sistemų ir :term:`duomenų rinkinių <duomenų rinkinys>` sąrašą.

Šiame etape svarbiausiai gerai suprasti kas yra informacinė sistema, duomenų rinkinys ir
distribucija.

.. image:: /static/rinkinys.png
    :align: right

**Informacinė sistema** yra duomenis apdorojanti (renkanti, sauganti, teikianti) sistema. Valstybės įstaigoms,
valdančioms informacines sistemas, ir norinčioms teikti jų duomenis,
pirmiausiai reikia užregistruoti Informacinę sistemą.
...
skaičiuoklės lentelė, katalogas, kuriame laikomi dokumentai, REST arba SOAP API ir pan.
